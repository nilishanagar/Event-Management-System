...
const RegistrationForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    {Axios.post('https://event-management-system-backend-eyjc.onrender.com/eventRoute/create-user', formData)
    .then((res) => {
      if(res.status === 200)
      {
      ...
      Axios.all([
        ...
        Axios.put("https://event-management-system-backend-eyjc.onrender.com/eventRoute/update-user/" + props.id, userData)
        .then(response => {
